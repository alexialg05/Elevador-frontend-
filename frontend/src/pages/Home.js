...
const secondaryNavigation = [
  { name: 'Last 7 days test', href: '#', current: true },
...
const statuses = {
  Safe: 'text-green-700 bg-green-50 ring-green-600/20',
  Maintenance: 'text-gray-600 bg-gray-50 ring-gray-500/10',
  Out_of_service: 'text-red-700 bg-red-50 ring-red-600/10',
};
const days = [
  {
    date: 'Today',
...
export default function Home() {
  // Change the menu if the application is in mobile mode
